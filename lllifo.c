...
lllifo_t *lllifo_create(int capacity)
{
    ...
    if (capacity == 0)
    {
        ...
        assert(list); // checking if malloc has memory to allocate
        list->head = NULL;
    ...
    assert(list->head); // checking if malloc has memory to allocate
    (list->head)->data = 0;
    (list->head)->next = NULL;
    ...
    for (int i = 0; i < capacity - 1; i++)
    {
        ...
        assert(newnode); // checking if malloc has memory to allocate
        newnode->data = 0;
        newnode->next = NULL;
